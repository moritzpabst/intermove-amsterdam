...
// ─── Room canvas (shared between planner steps) ───────────────────────────────
...
function RoomCanvas({
  ...
  widNum: number;
  lenNum: number;
  visibleFurniture: FurniturePiece[];
}) {
  return (
...
export default function BundleFlow() {
  ...
  // Scroll to section top on step transition so content is always in view
  ...
  // Room shape preview dimensions (constrained to a small box)
  const previewMaxW = 160,
    previewMaxH = 100;
  const ratio = widNum > 0 && lenNum > 0 ? widNum / lenNum : 1;
  const pw =
    ratio > previewMaxW / previewMaxH
      ? previewMaxW
      : Math.round(previewMaxH * ratio);
  const ph =
    ratio > previewMaxW / previewMaxH
      ? Math.round(previewMaxW / ratio)
      : previewMaxH;
            ...
            <div className="grid md:grid-cols-2 gap-5 max-w-4xl mx-auto">
              ...
              >
                ...
                <ul className="space-y-2.5 mb-8">
                  {[
                    "Everything chosen for you",
                    "Just pick your bed size",
                    "Ready in minutes",
                  ].map((b) => (
                    <li
                      key={b}
              ...
              >
                ...
                <ul className="space-y-2.5 mb-8">
                  {[
                    ...
                    "Toggle furniture on or off",
                    "See your room before delivery",
                  ].map((b) => (
                    <li
                      key={b}
                      className="flex items-center gap-2.5 text-sm text-gray-500"
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="max-w-xl mx-auto">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white rounded-2xl p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-sm font-semibold text-[#0F0F0F] mb-0.5">
                ...
                <div className="bg-white rounded-2xl p-7">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-400 mb-5">
                        90 cm fits most student rooms. 140 cm if you have the
                        space.
                      </p>
                      <div className="grid grid-cols-2 gap-3">
                        {(["90", "140"] as BedSize[]).map((size) => (
                ...
                {/* Summary — appears once dims are valid */}
                {dimsValid && (
                  <div className="animate-fade-in-up bg-[#0F0F0F] rounded-2xl p-7">
                    {!ordered ? (
                      <>
                        {/* Bundle header */}
                        ...
                        {/* Includes list */}
                        <div className="mb-7">
                          <div className="text-[10px] font-bold text-gray-600 uppercase tracking-[0.15em] mb-3">
                            What&apos;s included
                          </div>
                          <ul className="space-y-2">
                            {STANDARD_INCLUDES.map((item) => (
                              ...
                              >
                                <span className="w-4 h-4 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0 text-white">
                                  <CheckMark size="xs" />
                                </span>
                                {item}
                              </li>
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="max-w-xl mx-auto">
              <div className="mb-10">
                ...
                <p className="text-gray-400 mt-4 text-lg">
                  Enter your room dimensions. We&apos;ll build an accurate floor
                  plan to match.
                </p>
              </div>

              <div className="bg-white rounded-2xl p-8">
                <h3 className="text-sm font-semibold text-[#0F0F0F] mb-5">
                  Room dimensions
                </h3>
                  ...
                  <div className="flex items-center justify-center bg-[#F5F5F5] rounded-xl py-8 min-h-[140px]">
                    {dimsValid ? (
                      <div className="flex flex-col items-center gap-4">
                        ...
                        >
                          ...
                          <div className="absolute -right-7 top-0 bottom-0 flex flex-col items-center justify-center">
                            <span className="text-[8px] text-gray-400 font-mono [writing-mode:vertical-rl] select-none">
                              {roomLength} m
                            </span>
                          </div>
                          {/* Area label */}
                      ...
                      <span className="text-xs text-gray-300">
                        Enter dimensions above to preview
                      </span>
                    )}
                  </div>
                </div>
                ...
                <p className="text-xs text-gray-400 mb-6 leading-relaxed">
                  ...
                  Check your rental agreement or measure from wall to wall.
                  Values between 1 – 20 m.
                </p>

                <button
                  onClick={() => {
                    if (dimsValid) goTo("personalised-planner");
                  }}
                  disabled={!dimsValid}
        ...
        {step === "personalised-planner" && (
          <div className="animate-fade-in-up">
            ...
            <div className="grid lg:grid-cols-[240px,1fr] gap-5">
              ...
              {/* Room canvas — exact aspect ratio from user's dimensions */}
              <RoomCanvas
                widNum={widNum}
                lenNum={lenNum}
